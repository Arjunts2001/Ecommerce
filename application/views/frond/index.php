      ...
      <main>
         ...
         <section class="tp-slider-area p-relative z-index-1">
            <div class="tp-slider-active tp-slider-variation swiper-container">
               ...
               <?php if(!empty($banner)){
                  // print_r($banner);
                  foreach($banner as $data=>$bann){?>
                     <script>console.log("<?=$bann->id?>");</script>
                              ...
                              <div class="row">
                                 <?php if(!empty($prodt)):
                                    foreach($prodt as $pro):
                                       $cate_name = $this->HomeModel->category_name($pro->category);
                                    ?>
                                 <div class="col-xl-3 col-lg-3 col-sm-6">
                                    <div class="tp-product-item p-relative transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product/<?= $pro->slug?>">
                                             <img src="uploads/<?= $pro->pro_main_image ?>" alt="product-electronic">
                                          </a>
                                       ...
                                       <div class="tp-product-content">
                                          ...
                                          <div class="tp-product-price-wrapper">
                                             <span class="tp-product-price old-price">$<?= number_format($pro->mrp,2)?></span>
                                             <span class="tp-product-price new-price">$<?= number_format($pro->selling_price,2)?></span>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
